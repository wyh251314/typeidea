# -*- coding: utf-8 -*-
# Generated by Django 1.11.22 on 2019-07-16 04:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(choices=[(1, '正常'), (0, '删除')], default=1, verbose_name='正常')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(choices=[(1, '正常'), (0, '删除'), (2, '草稿')], default=1, verbose_name='正常')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
